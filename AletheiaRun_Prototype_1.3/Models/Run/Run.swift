...
enum GaitCyclePhase: String, CaseIterable, Identifiable {
    ...
    var color: Color {
        switch self {
        case .landing: return Color(hex: "F87171")  // Red - Impact
        case .stabilizing: return Color(hex: "FCD34D")  // Yellow - Support
        case .launching: return Color(hex: "4ADE80")  // Green - Propulsion
        case .flying: return Color(hex: "60A5FA")  // Blue - Flight
        }
    }
    ...
    var icon: String {
        ...
        case .flying: return "airplane.circle.fill"
        }
    }
