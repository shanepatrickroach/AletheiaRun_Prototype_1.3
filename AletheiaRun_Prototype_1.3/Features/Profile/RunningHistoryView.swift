    ...
    var body: some View {
        Button(action: action) {
            HStack(spacing: Spacing.m) {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 6)
                        .stroke(isEnabled ? metricInfo.color : Color.cardBorder, lineWidth: 2)
            ...
            .overlay(
                RoundedRectangle(cornerRadius: CornerRadius.medium)
                    .stroke(
                        isEnabled ? metricInfo.color.opacity(0.5) : Color.cardBorder,
        ...
        VStack(spacing: 0) {
            ...
            if isExpanded {
                VStack(spacing: Spacing.m) {
                    ...
                    HStack(spacing: Spacing.m) {
                        StatItem(label: "Best", value: "\(stats.best)", color: .successGreen)
                        StatItem(label: "Worst", value: "\(stats.worst)", color: .errorRed)
                        StatItem(label: "Range", value: "\(stats.range)", color: .infoBlue)
                    }
                        ...
                        GeometryReader { geometry in
                            ZStack(alignment: .leading) {
                                ...
                                RoundedRectangle(cornerRadius: 4)
                                    ...
                                    .frame(
                                        width: geometry.size.width * CGFloat(stats.consistency) / 100,
                                        height: 8
                                    )
                            }
                        }
