...
struct ActiveRunView: View {
    ...
    var body: some View {
        ...
        .alert("End Session?", isPresented: $showingEndConfirmation) {
            ...
            Text(
                "Are you sure you want to end this session? Your data will be saved."
            )
        }
    ...
    private var sensorStatus: some View {
        HStack(spacing: 6) {
            Circle()
                .fill(
                    bluetoothManager.connectedSensor != nil
    ...
    private var readyToStartView: some View {
        VStack(spacing: Spacing.xl) {
            ...
            Text(
                "Tap the play button when you're ready to begin your \(configuration.mode.rawValue.lowercased()) session"
            )
                ...
                HStack(spacing: 4) {
                    ForEach(0..<20, id: \.self) { index in
                        RoundedRectangle(cornerRadius: 2)
                            ...
                            .frame(
                                width: 6, height: CGFloat.random(in: 20...80)
                            )
                            .animation(
